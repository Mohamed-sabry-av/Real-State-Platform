...
export class ProductsService {
  // Store the data within the service
  private listData: Apartment[] = [
    {
      id: 1,
  ...
  private singlePostData: SinglePost = {
    id: 1,
  ...
  getApartmentById(id: number): Apartment | undefined {
    return this.listData.find(apartment => apartment.id === id);
  }
}